...
from .views import (
                    ...
                    parent_remove_student_from_lesson_confirm_view,
                    remove_student_from_lesson_view,
                    )

urlpatterns = [
        path('view_lessons/', get_student_lessons_view, name="get_student_lessons"),
        path('remove_student/<int:lesson_id>/<int:student_id>', parent_remove_student_from_lesson_confirm_view, name='remove_student_from_lesson_confirm'),
